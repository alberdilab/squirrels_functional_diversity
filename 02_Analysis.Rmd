...
GIFTs_elements_community <- to.community(GIFTs_elements_filtered, tss(genome_counts_filt), GIFT_db)
GIFTs_functions_community <- to.community(GIFTs_functions,tss(genome_counts_filt), GIFT_db)
GIFTs_domains_community <- to.community(GIFTs_domains,tss(genome_counts_filt), GIFT_db)
```
